...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e7b17247-1c91-47eb-985f-e1980a53b374
```

> `e7b17247-1c91-47eb-985f-e1980a53b374` is the password of the certificate, you can change it to any password you want.
